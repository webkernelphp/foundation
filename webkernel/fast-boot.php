...
defined('WEBKERNEL_VERSION')     || define('WEBKERNEL_VERSION','0.11.1');
defined('WEBKERNEL_BUILD')       || define('WEBKERNEL_BUILD',92);
defined('WEBKERNEL_SEMVER')      || define('WEBKERNEL_SEMVER','0.11.1+92');
...
defined('WEBKERNEL_COMMIT')      || define('WEBKERNEL_COMMIT','06bfb06');
defined('WEBKERNEL_COMMIT_FULL') || define('WEBKERNEL_COMMIT_FULL','06bfb06f0cf1aa8bc8faf585a97fc8a65f37418d');
defined('WEBKERNEL_BRANCH')      || define('WEBKERNEL_BRANCH','main');
defined('WEBKERNEL_TAG')         || define('WEBKERNEL_TAG','v0.11.1');
