...
defined('WEBKERNEL_VERSION')     || define('WEBKERNEL_VERSION','0.11.4');
defined('WEBKERNEL_BUILD')       || define('WEBKERNEL_BUILD',95);
defined('WEBKERNEL_SEMVER')      || define('WEBKERNEL_SEMVER','0.11.4+95');
...
defined('WEBKERNEL_TAG')         || define('WEBKERNEL_TAG','v0.11.4');
